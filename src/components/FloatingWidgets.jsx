    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-4 items-center">
        ...
        <a 
          ...
          className="w-14 h-14 bg-green-500 text-white rounded-full flex items-center justify-center shadow-[0_0_15px_rgba(34,197,94,0.5)] hover:scale-110 hover:shadow-[0_0_25px_rgba(34,197,94,0.8)] transition-all duration-300 cursor-pointer"
        >
